...
module.exports = async (sock, msg, comando, args, db, salvarDB) => {
    ...
    switch (comandoBase) {
        case 'menujogos': {
            const menuJogosTxt = `░▒▓█████████████████████████████████████▓▒░\n▓██  🎮  𝗟𝗘𝗜𝗖𝗬𝗕𝗢𝗧 - 𝗝𝗢𝗚𝗢𝗦 & 𝗕𝗥𝗜𝗡𝗖𝗔𝗗𝗘𝗜𝗥𝗔𝗦  🎮  ██▓\n░▒▓█████████████████████████████████████▓▒░\n 🌊 A zoeira e os mini-games oficiais do grupo!\n\n 💞 *BRINCADEIRAS*\n ➔ *!duelo [@user ou responda] [aposta]* - Combate valendo Golds.\n ➔ *!casar [@user ou responda]* - Faz o pedido oficial de matrimônio.\n ➔ *!aceitar* - Consuma a união sob a benção de Olden.\n ➔ *!divorciar* - Encerra o casamento virtual.\n ➔ *!beijar / !bater / !abracar [@user ou responda]* - Ações textuais cômicas.\n ➔ *!gado* - Mede o nível de paixão boba do membro.\n ➔ *!gostoso* - Avalia a latência da sua beleza.\n ➔ *!curiosidade* - Fato aleatório global do robô.\n ➔ *!curiosidade/[categoria]* - Alvo estrito:\n    _(sports, games, ciencia, arte, filmes, historia, animes, tecnologia, natureza)_\n ➔ *!topbeijos* / *!topabracos* - Ranking global de quem mais recebeu.\n ➔ *!casaldomes* - O casal virtual mais afetuoso do momento.\n\n 🕹️ *JOGOS EM GRUPO*\n ➔ *!forca* - Forca coletiva: chute letras com *!chutar*.\n ➔ *!jogodavelha [@user]* - Desafio de jogo da velha (*!aceitarvelha*, *!jogar*).\n ➔ *!ppt [pedra/papel/tesoura]* - Pedra, papel ou tesoura contra o bot.\n ➔ *!verdadeoudesafio [@user]* - Sorteia verdade ou desafio.\n ➔ *!emojicharada* - Adivinhe a palavra pelos emojis.\n ➔ *!quiz* - Pergunta de conhecimento geral valendo Golds.\n ➔ *!palavraencadeada* - Corrente de palavras, sem repetir nenhuma.\n ➔ *!sorteio [prêmio]* - Cria um sorteio no grupo (*!participar*, *!sortear*).\n ➔ *!enquete Pergunta|Opção1|Opção2* - Enquete nativa do WhatsApp.\n ➔ *!roletarussa [aposta]* - Roleta de sorte: 1 chance em 6 de perder a aposta.\n ➔ *!simon* - Decore e repita a sequência de cores.\n ➔ *!adivinhanumero* - Adivinhe o número secreto entre 1 e 100.\n ➔ *!anagrama* - Desembaralhe as letras e descubra a palavra.\n ➔ *!digitacao* - Corrida de digitação, vale quem for mais rápido.\n ➔ *!30s [vermelha/azul]* - "30 segundos" em times (*!iniciar30s*, *!placar30s*).\n ➔ *!batalhanaval [@user]* - Desafio de batalha naval (*!aceitarbatalha*, *!atirar*).\n░▒▓█████████████████████████████████████▓▒░`;
